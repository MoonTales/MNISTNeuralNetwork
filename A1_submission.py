...
def tune_hyper_parameter(target_metric, device):
    ...
    print(f"Best hyperparameters: lr={best_params[0]}, weight_decay={best_params[1]} with accuracy {best_accuracy:.2f}%")
    ...
    best_metric = [{"logistic_validation_accuracy": best_accuracy}]
