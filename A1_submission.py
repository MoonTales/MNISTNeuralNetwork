...
def logistic_regression(device):
    ...
    class LogisticRegressionModel(nn.Module):
        ...
        class Hyperparameters:
            ...
            """
            def __init__(self, learning_rate=2.3e-2, lambda_value=0.001, n_epochs=21, log_interval=75):
        ...
        def evaluate(self, data_loader, model, dataset):
    ...
    for epoch in range(1, LRM.Hyperparameters.n_epochs + 1):
        LRM.train_model(epoch, LRM.train_loader, LRM, LRM.Optimizer, lambda_value=LRM.Hyperparameters.lambda_value)
        LRM.evaluate(LRM.validation_loader, LRM, "Validation")
...
def tune_hyper_parameter(target_metric, device):
    ...
    for lr in learning_rates_logistic:
        ...
        for epoch in range(1, 4):  # Use base_epochs_log = 3
            train(epoch, LRM.train_loader, LRM, optimizer, log_interval=100, device=device)
